# [http://penguinssoftware.com](http://penguinssoftware.com)

My personal website. Easily modifiable, and built using modern javascript with Node.js, React, Express, React-Router, Hot Module Reloading, Webpack and many other technologies.

The master branch of this repository contains a simplified version of my website intended for serverless hosting on github pages. To view the source for the version hosted at [https://github.com/smartsnake/personal-website](https://github.com/smartsnake/personal-website),.

## A note on adapting this repository to your own personal website

Many people have contacted me about adapting this website. I have tried to make things as simple as possible. There are still bugs. I am sorry. If you find a bug, please email me (help@penguinssoftware.com) or submit an issue or a pull request.
...
1. To download the repository and install dependencies, run the following commands:
    ...
    ```bash
    git clone git://github.com/smartsnake/personal-site.git
    cd personal-site
    npm install
    ```
...
4. Modify the files in `app/data/Services/` next. When you're finished, go back and modify all of the other files in the `app/data/` directory.
...
(e.g. [https://smartsnake.github.io/personal-site/](https://smartsnake.github.io/personal-site/)), you should modify `BASE_PATH` in your `.env` and `sample.env` files and restart the express server. Note that you will now have to navigate to `localhost:[port]/[BASE_PATH]` when developing.
...
Please feel free to reach out to me by filing an issue or at help@penguinssoftware.com for help configuring your project.
...
* Awesomely thanks to [@mldangelo](https://github.com/mldangelo) for there personal website that mine is based on.
* Special thanks to [@typpo](https://github.com/typpo) for tirelessly answering all of my node.js and react questions.
* Template based on [Future Imperfect](https://html5up.net/future-imperfect) by [@ajlkn](https://github.com/ajlkn) for [HTML5 UP](html5up.net).

## License

[MIT](https://github.com/smartsnake/personal-site/blob/master/LICENSE)
